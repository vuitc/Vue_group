            ...
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                ...
                <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                    <div class="navbar-nav mx-auto">
                        ...
                        <router-link to="/detail" class="nav-item nav-link">Detail</router-link>
                        <div class="nav-item dropdown">
                            <router-link to="/404" class="nav-link dropdown-toggle"
                                data-bs-toggle="dropdown">Pages</router-link>
                            ...
                            <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                ...
                                <router-link to="/404" class="dropdown-item">404</router-link>
                            </div>
                        </div>
                    ...
                    <div class="d-flex m-3 me-0">
                        ...
                        <router-link to="/cart" class="position-relative me-4 my-auto">
                            ...
                            <span
                                ...
                                style="top: -5px; left: 15px; height: 20px; min-width: 20px;">{{ cartQuantity }}</span>
                        </router-link>
                        <router-link to="/login" v-if="!isLoggedIn">Đăng nhập</router-link>
                        <router-link to="/register" v-if="!isLoggedIn">Đăng kí</router-link>
                        
                        <!-- Example split danger button -->
                        <div class="btn-group" v-if="isLoggedIn">
                            <a class="btn btn-link">{{ isEmail }}</a>
                            <button type="button" class="btn btn-link dropdown-toggle dropdown-toggle-split"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                <span class="visually-hidden">Toggle Dropdown</span>
                            </button>
                            <ul class="dropdown-menu" >
                                <li ><a class="dropdown-item" @click="logout" style="padding:8px 58px;" >Đăng xuất</a></li>
                            </ul>
                        </div>
...
export default {
    ...
    computed: {
        ...mapState(["cart", "isLoggedIn", "isEmail"]),
        ...mapGetters(['cartSize', 'cartQuantity',]),
