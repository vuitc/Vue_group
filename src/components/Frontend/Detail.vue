        ...
        <div class="col-lg-8 col-xl-9">
          <div class="row g-4">
            ...
            <div v-if="product" class="col-lg-6">
              ...
              <p class="mb-4">
                <!-- Additional details: You can add more product details here -->
              </p>
              ...
              <div class="tab-content mb-5">
                ...
                <div class="tab-pane" id="nav-vision" role="tabpanel">
                  <p class="text-dark">
                    ...
                    Aliqu diam amet diam et eos labore. 3
                  </p>
                  <p class="mb-0">
...
export default {
  ...
  mounted() {
    this.fetchProduct(this.$route.params.id); // Gọi hàm fetchProduct với id của sản phẩm từ route params
  },
  methods: {
